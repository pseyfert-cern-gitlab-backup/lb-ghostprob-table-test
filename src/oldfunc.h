 ...
 *
 *  Header file for utility class : Track::OldFunc
 *
...
#ifndef TRACKKERNEL_RICH1DTABFUNC_H
#define TRACKKERNEL_RICH1DTABFUNC_H 1
...
namespace Track
{
  ...
  //============================================================================
  /** @class Track::OldFunc Track1DTabFunc.h
   *
  ...
  public:
    ...
    /// Typedef for a vector of pointers to OldFunc
    using ConstVector = std::vector<const OldFunc*>;
  ...
  public:
     ...
     */
    OldFunc( const gsl_interp_type * interType = gsl_interp_linear )
     ...
     *  @param interType GSL Interpolator type
     */
    OldFunc( const std::vector<double> & x,
     ...
     *  @param interType GSL Interpolator type
     */
    OldFunc( const std::map<double,double> & data,
                         const gsl_interp_type * interType = gsl_interp_linear )
      : m_interType ( interType )
    {
     ...
     *  @param interType GSL Interpolator type
     */
    OldFunc( const std::vector< std::pair<double,double> > & data,
                         const gsl_interp_type * interType = gsl_interp_linear )
      :
      m_interType ( interType )
    {
  ...
  public:
    ...
    double rms( const double from,
                const double to,
                const unsigned int samples = 100,
                const OldFunc * weightFunc = nullptr ) const;
...
#endif // TRACKKERNEL_RICH1DTABFUNC_H
