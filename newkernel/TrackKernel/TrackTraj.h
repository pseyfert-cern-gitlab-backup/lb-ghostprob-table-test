...
namespace LHCb
{
  ...
  public:
    ...
    Point position( double z ) const override;

    /// First derivative of the trajectory at arclength from the starting point
    Vector direction( double z ) const override;

    /// Second derivative of the trajectory at arclength from the starting point
    Vector curvature( double z ) const override;
    ...
    void expansion( double z, Point& p, Vector& dp, Vector& ddp ) const override;
    ...
    double muEstimate(const Gaudi::XYZPoint& p) const override;
    ...
    std::vector<StateVector> refStateVectors() const override;
